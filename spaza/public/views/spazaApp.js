var spazaApp = angular.module('spaza',[])

spazaApp.controller('Store',['$scope','$http',function($scope,$http){
				...
				$scope.products;
				$http.get('http://127.0.0.1:8080/products/all').success(function(data){$scope.products=data;console.log(data)})
